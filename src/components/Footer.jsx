      ...
      <div className="footer-inner container">
        ...
        <div className="footer-middle" aria-label="Quick links">
          ...
          <nav className="quicklinks" aria-label="Footer navigation">
            <a href="#" onClick={(e)=>e.preventDefault()} className="footer-link">Home</a>
            <a href="#" onClick={(e)=>e.preventDefault()} className="footer-link">About us</a>
            <a href="#" onClick={(e)=>e.preventDefault()} className="footer-link">Services</a>
            <a href="#" onClick={(e)=>e.preventDefault()} className="footer-link">Gallery</a>
